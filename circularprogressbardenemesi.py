...
_DEFAULT_TEXT_LABEL = Label(text="{}%", font_size=10)
...
class CircularProgressBar(Widget):
    ...
    def __init__(self, **kwargs):
        ...
        print("CircularProgressBar initialized")
    ...
    def _draw(self):
        ...
        with self.canvas:
            ...
            Line(circle=(self.center_x, self.center_y, self._widget_size / 2 - self._thickness), width=self._thickness)

            # Draw the progress line
            Color(*self.progress_colour)
            Line(circle=(self.center_x, self.center_y, self._widget_size / 2 - self._thickness, 0,
            ...
            Rectangle(texture=self._text_label.texture, size=self._label_size,
                      pos=(self.center_x - self._label_size[0] / 2, self.center_y - self._label_size[1] / 2))
